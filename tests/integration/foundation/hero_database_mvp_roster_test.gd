...
## AC-2: MVP roster record count must be within [8, 20] inclusive.
## Phase A bumped upper bound 13 → 16 (added 조운/제갈량).
## Phase B bumped 16 → 20 to accommodate 위연 + headroom for 방통/마초/강유 (Phase C/D/E).
