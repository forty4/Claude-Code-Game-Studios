...
# ─── shu_canon_main integration sentinel ─────────────────────────────────────────────
...
## shu_canon_main.json 의 5 cascade entry 챕터 (ch14/17/21/22/23) 가 모두
## cascade_join_prose entry 를 authored 했는지 데이터 sentinel.
func test_shu_canon_main_authors_all_five_cascade_join_prose_entries() -> void:
