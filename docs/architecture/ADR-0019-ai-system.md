...
## Status
Proposed (2026-05-04 — fresh authoring per `/gate-check pre-production` 2026-05-04 path-to-PASS item #4 ADR completion. GDD shipped 2026-05-04 commit `b9acb98`. Ready for fresh-session `/architecture-review` for Accepted escalation per same-session-ban discipline.)
