...
- **ADR-0006 Balance/Data** (Accepted 2026-04-26) — `BalanceConstants.get_const(key) -> Variant` consumer contract for all 27 tuning knob reads per §12; G-15 `_cache_loaded` reset obligation for HP/Status test suites per Validation §5.
