...
| [013](story-013-natural-loop-integration-test.md) | Natural-loop integration test (G-30 mitigation infrastructure; FIRST natural-loop test in codebase) — drives full battle via `BattleScene._ready()` → `_begin_round.call_deferred()` → `victory_condition_detected` emit through natural deferred-chain progression; verifies POLISH-011 closure end-to-end | Integration | Ready (sprint-15 S15-D; was BLOCKED on S15-J close via mid-amend `77d271f` — UNBLOCKED 2026-05-10 sprint-15 S15-J close; 9 ACs; chapter-1 fixture; player+AI both paths) | (TR-grid-battle-controller-011 + ADR-0014 §Amendment 2026-05-10 #1+#2 + ADR-0011 §Amendment 2026-05-09 + ADR-0016 §3) | (pending) | 2-3h |
