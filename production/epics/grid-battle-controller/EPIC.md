...
> **Status**: In Progress (13/14 stories shipped — story-014 closed 2026-05-10 sprint-15 S15-J POLISH-012 closure / 4th POLISH-011 absorption arc root cause; story-013 S15-D natural-loop integration test now UNBLOCKED for resume; epic regressed from terminal 12/12 Complete via 77d271f mid-sprint amendment that added story-013 + story-014 — 4th graduation candidate after story-013 closes)
> **Stories**: 14/14 created · **13/14 Complete** (story-001..010 shipped 2026-05-03 + story-011 shipped 2026-05-10 sprint-15 S15-B + story-012 shipped 2026-05-10 sprint-15 S15-C + story-014 shipped 2026-05-10 sprint-15 S15-J; story-013 Ready unblocked) — see Stories table below
...
| [011](story-011-polish-011-ai-action-ready-subscriber.md) | POLISH-011 absorption #2 of 3 — `_on_ai_action_ready` handler + `ai_action_ready` subscriber + AIActionCommand → TurnOrderRunner.ActionType dispatch + declare_action plumbing for 5 actions (USE_SKILL deferred per ADR-0014 §0) | Integration | Complete (2026-05-10 sprint-15 S15-B close; 8/8 ACs verified; +12 tests 1295→1307; +2 guard tests added post-/code-review; design deviation `_do_move`/`_resolve_attack` bypass documented in ADR-0014 §Amendment 2026-05-10) | (ADR-0014 §8 + ADR-0019 §Decision §Payload Form + ADR-0011 §Amendment 2026-05-09) | +12 tests | 2-4h |
| [012](story-012-polish-011-player-declare-action-plumbing.md) | POLISH-011 absorption #3 of 3 (final root cause) — `_handle_player_move` (L831) / `_handle_player_attack` (L844) / `_handle_player_end_turn` (L524) 3 helpers mirroring S15-B AI-path bypass + 5-arm rewire in `_handle_grid_click_unit_selected` (move/attack/confirm × 2 + end_unit_turn) + ADR-0014 §Amendment 2026-05-10 (#2) extension | Integration | Complete (2026-05-10 sprint-15 S15-C close; 9/9 ACs verified; +7 tests 1307→1314; /code-review APPROVED with 1 BLOCKING ADR cross-ref fix + 5 ADVISORY suggestions deferred to S15-D drafting + retro debt) | (ADR-0014 §6 + ADR-0014 §Amendment 2026-05-10 #2 + ADR-0011 §Amendment 2026-05-09) | +7 tests | 3-5h |
| [013](story-013-natural-loop-integration-test.md) | Natural-loop integration test (G-30 mitigation infrastructure; FIRST natural-loop test in codebase) — drives full battle via `BattleScene._ready()` → `_begin_round.call_deferred()` → `victory_condition_detected` emit through natural deferred-chain progression; verifies POLISH-011 closure end-to-end | Integration | Ready DEFERRED to sprint-16 (sprint-15 S15-D — 3-spawn-cycle attempt 2026-05-10 PM very-late surfaced deferred-chain progression gap exceeding 2-3h estimate per POLISH-013; META-pattern: test designed to close G-30 surfaced NEW G-30 instance — verification gap pattern #6) | (TR-grid-battle-controller-011 + ADR-0014 §Amendment 2026-05-10 #1+#2+#3 + ADR-0011 §Amendment 2026-05-09 + ADR-0016 §3) | (pending sprint-16 reauthoring) | 2-3h → ~3h actual + DEFERRED |
| [014](story-014-set-action-controller-production-wiring.md) | POLISH-012 closure (POLISH-011 absorption arc 4/4 root cause — production-wiring residual) — new `_on_turn_runner_action_request` handler on GridBattleController (side-routing player/enemy via existing ai_action_requested chain) + BattleScene._ready STEP 5 wire-up `_turn_runner.set_action_controller(...)` BEFORE `add_child` + ADR-0014 §Amendment 2026-05-10 (#3) integration site documentation | Integration | Complete (2026-05-10 sprint-15 S15-J close; 6/6 ACs verified; +6 tests 1314→1320; /code-review APPROVED WITH SUGGESTIONS — 1 P1 wildcard arm test added inline + 7 ADVISORY suggestions deferred per Route a; 2 design corrections vs spec documented in ADR Amendment #3 §Key clarifications) | (TR-grid-battle-controller-011 + TR-turn-order-001 + ADR-0011 §Amendment 2026-05-09 + ADR-0014 §Amendment 2026-05-10 #1+#2+#3 + ADR-0016 §3) | +6 tests | 1-2h |
