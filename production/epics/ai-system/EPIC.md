...
|---|-------|------|--------|--------|----------|
| [001](story-001-ai-system-impl-and-pillar-2-lock-4th-precedent.md) | AISystem implementation per ADR-0019 Migration Plan §2..§5 + Pillar 2 architectural lock 4th precedent enforcement (epic-terminal) | Logic + Integration | **Ready** (depends on scenario-progression story-001 for ChapterDefinition.enemy_roster archetype field consumer per Decision B coordination) | TR-ai-system-001..015 (all 15) + AC-LINT-AI-1..2 + AC-GBC-1..4 + AC-MOUNT-1 + AC-CHAPTER-1 + AC-BC-1 | ~5-6h (0.5d nominal per sprint-7 plan; intermediate scale between scenario-progression story-001 multi-spawn and destiny-branch story-001 single-spawn — likely 1 SendMessage continuation) |
