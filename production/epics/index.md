...
| [unit-role](unit-role/EPIC.md) | Foundation | Unit Role System (#5) | design/gdd/unit-role.md | ADR-0009, ADR-0001, ADR-0006, ADR-0008 | 3/10 Complete + 7 Ready (stories 001+002+007 done 2026-04-28) | **In Progress** (2026-04-28) — JSON loader + 6×12 coefficient table + 8-key balance_entities.json append shipped |
