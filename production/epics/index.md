...
> **Last Updated**: 2026-04-30 (Sprint 2 S2-01 — balance-data Ready; comprehensive post-sprint-1 layer refresh deferred to S2-05)
> **Engine**: Godot 4.6
> **Manifest Version**: 2026-04-20 (docs/architecture/control-manifest.md)
> **Layer coverage**: Platform (3/3 epics Complete 🎉) + Foundation (**2/5 epics Complete + 1 Ready** — map-grid + unit-role 🎉; balance-data Ready 2026-04-30) + Core (1/4 epics Complete — terrain-effect 🎉) + **Feature (1/13 epics Complete — damage-calc Complete 2026-04-27 🎉)**
>
> **Note**: All 12 ADRs reached Accepted on 2026-04-30 (commit `2fa178b`). hero-database / hp-status / turn-order / input-handling Pending entries below now have Accepted ADRs and will graduate to Ready as their epics are scaffolded across Sprint 2 (S2-02 hero-database, S2-07 hp-status, S2-08 turn-order, S2-09 input-handling).
...
| [balance-data](balance-data/EPIC.md) | Foundation | Balance/Data System (#26) | design/gdd/balance-data.md | ADR-0006, ADR-0001 | **5/5 stories Ready** (2026-04-30) | **Ready** (2026-04-30) — ratification epic for shipped MVP wrapper (PR #65 2026-04-27); 20/20 TRs traced (7 COVERED + 13 Alpha-deferred BY DESIGN per ADR-0006 §7); Sprint 2 S2-03 implementation begins after `/qa-plan balance-data` |
...
### Foundation layer (2 pending — balance-data graduated to Ready 2026-04-30)
...
| hero-database | Foundation | Hero Database (#25) | design/gdd/hero-database.md | ~~ADR-0007~~ Accepted 2026-04-30 — Sprint 2 S2-02 will scaffold | LOW |
