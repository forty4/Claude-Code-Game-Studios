...
| [unit-role](unit-role/EPIC.md) | Foundation | Unit Role System (#5) | design/gdd/unit-role.md | ADR-0009, ADR-0001, ADR-0006, ADR-0008 | 1/10 Complete + 9 Ready (story-001 done 2026-04-28; sprint-2 fodder) | **In Progress** (2026-04-28) — first source code authored |
