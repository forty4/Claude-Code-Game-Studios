...
> **Last Updated**: 2026-05-01 (Sprint 2 S2-02 — hero-database Ready; balance-data 5/5 Complete 2026-05-01; comprehensive post-sprint-1 layer refresh deferred to S2-05)
> **Engine**: Godot 4.6
> **Manifest Version**: 2026-04-20 (docs/architecture/control-manifest.md)
> **Layer coverage**: Platform (3/3 epics Complete 🎉) + Foundation (**3/5 epics Complete + 1 Ready** — map-grid + unit-role + balance-data 🎉; hero-database Ready 2026-05-01) + Core (1/4 epics Complete — terrain-effect 🎉) + **Feature (1/13 epics Complete — damage-calc Complete 2026-04-27 🎉)**
>
...
| [hero-database](hero-database/EPIC.md) | Foundation | Hero Database (#25) | design/gdd/hero-database.md | ADR-0007, ADR-0001, ADR-0006, ADR-0009 | Not yet created — run `/create-stories hero-database` | **Ready** (2026-05-01) — build-from-scratch epic with §Migration Plan §1 head-start (provisional `hero_data.gd` 26-field shape shipped 2026-04-30); 15/15 TRs traced (11 MVP-runtime + 4 Polish-deferred F-1..F-4); 5th-precedent stateless-static pattern (ADR-0008→0006→0012→0009→0007); LOW engine risk |
...
### Foundation layer (1 pending — balance-data + hero-database graduated to Ready)
