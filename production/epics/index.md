...
> **Last Updated**: 2026-05-01 (Sprint 2 S2-04 — hero-database epic Complete 5/5; S2-05 admin pass — comprehensive post-sprint-1 layer refresh still deferred to dedicated cleanup story)
> **Engine**: Godot 4.6
> **Manifest Version**: 2026-04-20 (docs/architecture/control-manifest.md)
> **Layer coverage**: Platform (3/3 epics Complete 🎉) + Foundation (**4/5 epics Complete** — map-grid + unit-role + balance-data + hero-database 🎉) + Core (1/4 epics Complete — terrain-effect 🎉) + **Feature (1/13 epics Complete — damage-calc Complete 2026-04-27 🎉)**
>
...
| turn-order | Core | Turn Order/Action Management (#13) | design/gdd/turn-order.md (Accepted via ADR-0011 2026-04-30; Contract 5 invariant resolution prose added 2026-05-01 via S2-06) | ~~ADR-0011 + GDD revision~~ — both ✅ resolved 2026-04-30/2026-05-01; awaiting `/create-epics turn-order` at S2-08 | ⚠ partial (TR-turn-order-001 only — TR-turn-order-002..022 registered at ADR-0011 acceptance; epic creation at S2-08 expands TR registry coverage) | ~~Architecture.md §1 blocker~~ **RESOLVED 2026-04-30 via ADR-0011 §Why-this-form Callable-delegation rationale** + 2026-05-01 GDD Contract 5 prose addition (S2-06): Turn Order depends on generic `Callable` abstraction (Godot built-in primitive); AI System symbol references forbidden in Turn Order source; Battle Preparation (Feature-layer) injects per-unit controller Callable at BI-1. Signal-inversion evaluated and rejected per ADR-0011 §Alternatives Considered (round-trip latency + double-emit semantics + RoundState enum bloat). |
