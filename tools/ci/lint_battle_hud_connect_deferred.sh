...
#
# Scope: only the 11 GameBus / _grid_controller subscriptions are checked.
...
#   4. Assert filtered count == 11 (catches accidental subscription drop)
#
# Exit 0: all 11 GameBus/controller subscriptions use CONNECT_DEFERRED
