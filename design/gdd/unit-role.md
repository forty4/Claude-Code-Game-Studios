...
| COMMANDER | Rally (독전) | `passive_rally` | Adjacent allied units (Manhattan distance ≤ 1) receive +5% attack power. Continuous while commander is alive. Stacks additively from multiple commanders, cap 15% from this source. |
